...
class Astrometry(Tools):
    ...
    def register(self, max_stars=100, full_deep_frame=False,
        ...
        def get_filtered_params(fit_params, snr_min=None,
            ...
            if snr_min is None:
                snr_min = max(utils.robust_median(snr), 3.)
    ...
    def fit_sip(self, star_list1, star_list2, params=None, init_sip=None,
        ...
        def diff(p, star_list2, star_list1, 
            ...
            try:
                star_list_t = utils.transform_star_position_A_to_B(
                    star_list1, params[:5],
                    (params[5], params[6]),
                    (params[7], params[8]),
    ...
    def compute_alignment_parameters(self, correct_distorsion=False,
        ...
        def match_star_lists(p, slin, slout, rc, zf, sip1, sip2):
            ...
            def diff(p, slin, slout, rc, zf, sip1, sip2):
                slin_t = utils.transform_star_position_A_to_B(
                    slin, p, rc, zf,
        ...
        WARNING_DIST = .5 # Max optimized distance before a warning is raised
        ERROR_DIST = 1. # Max optimized distance before an error is raised
        ...
        star_list2 = utils.transform_star_position_A_to_B(
        ...
        fwhm_arc2 = utils.robust_mean(
            utils.sigmacut(fit_results[:, 'fwhm_arc']))
